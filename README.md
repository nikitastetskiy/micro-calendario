...
<dl>
    ...
    <br>
        ...
        Como resumen, las funciones de Vercel se encuentran en la carpeta (<a href="api">api</a>) y son tres, cada una con una funcionalidad diferente (<a href="api/hello.js">Hola Mundo</a>, <a href="api/calendar.js">Calendar</a> y <a href="api/calendar-bot.js">Calendar-bot</a>). Las funciones de Netlify se encuentran en la carpeta (<a href="functions">functions</a>) y son tres, cada una con una funcionalidad diferente (<a href="functions/hello/hello.js">Hola Mundo</a>, <a href="functions/protected/protected.js">Protected</a> y <a href="functions/graphql/graphql.js">GraphQL</a>). Las funciones de Netlify se encuentran organizadas cada una en su propio directorio, ya que han sido creadas de esa manera según <em>create</em> y debido que son <em>templates</em>.<br></br></li>
